...
let order = Burger(name: name, veggie: veggie, patties: patties, pickles: true, mayo: mayo, ketchup: true, lettuce: true, cook: .NORMAL, raddish: false)
...
builder.setKetchup(choice: true)
builder.setPickles(choice: true)
// Step 4 - Buy additional patty?
builder.addPatty(choice: true)

// Step 5 - Build
builder.buildObject(name: nameOrder)
